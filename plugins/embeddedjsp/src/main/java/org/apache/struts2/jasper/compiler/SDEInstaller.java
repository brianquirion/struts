...
public class SDEInstaller {
    ...
    private org.apache.juli.logging.Log log=
        org.apache.juli.logging.LogFactory.getLog( org.apache.struts2.jasper.compiler.SDEInstaller.class );
    ...
    static void install(File inClassFile, File attrFile, File outClassFile)
        throws IOException {
        new org.apache.struts2.jasper.compiler.SDEInstaller(inClassFile, attrFile, outClassFile);
    }

    static void install(File inOutClassFile, File attrFile)
        throws IOException {
        File tmpFile = new File(inOutClassFile.getPath() + "tmp");
        new org.apache.struts2.jasper.compiler.SDEInstaller(inOutClassFile, attrFile, tmpFile);
    ...
    static void install(File classFile, byte[] smap) throws IOException {
        ...
        new org.apache.struts2.jasper.compiler.SDEInstaller(classFile, smap, tmpFile);
        if (!classFile.delete()) {
